...
@InputType()
class DocumentDetailCreateNestedManyWithoutItemsInput {
...
export { DocumentDetailCreateNestedManyWithoutItemsInput as DocumentDetailCreateNestedManyWithoutItemsInput };
