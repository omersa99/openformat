...
@InputType()
class DocumentUpdateManyWithoutClientsAndSuppliersInput {
...
export { DocumentUpdateManyWithoutClientsAndSuppliersInput as DocumentUpdateManyWithoutClientsAndSuppliersInput };
