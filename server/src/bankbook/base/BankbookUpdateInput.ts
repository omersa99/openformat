...
@InputType()
class BankbookUpdateInput {
  @ApiProperty({
    required: false,
    type: () => AccountUpdateManyWithoutBankbooksInput,
  })
  @ValidateNested()
  @Type(() => AccountUpdateManyWithoutBankbooksInput)
  @IsOptional()
  @Field(() => AccountUpdateManyWithoutBankbooksInput, {
    nullable: true,
  })
...
export { BankbookUpdateInput as BankbookUpdateInput };
