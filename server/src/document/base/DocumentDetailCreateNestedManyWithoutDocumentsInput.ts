...
@InputType()
class DocumentDetailCreateNestedManyWithoutDocumentsInput {
...
export { DocumentDetailCreateNestedManyWithoutDocumentsInput as DocumentDetailCreateNestedManyWithoutDocumentsInput };
